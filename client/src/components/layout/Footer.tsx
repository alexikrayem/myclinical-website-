        ...
        <div className="section-modern">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            <div className="lg:col-span-2">
              ...
              <div className="relative h-14 mb-6 overflow-visible transition-all duration-300 ease-in-out"> 
                <Link to="/" className="absolute top-1/2 -translate-y-1/2 -translate-x+1/3 left-60 flex items-center z-10">
                  <img
                    src="/logo.png" // Path to your logo in the public folder
                    alt="طب الأسنان العربي Logo"
                    // ADDED transition-all duration-300 ease-in-out here
                    className="h-18 md:h-22 w-auto drop-shadow-lg transition-all duration-300 ease-in-out" 
                  />
                </Link>
              </div>
