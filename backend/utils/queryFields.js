...
export const COURSE_DETAIL_SELECT = `${COURSE_LIST_SELECT}, description, playback_source, preview_source, preview_seconds`;

export const TRANSACTION_SELECT = 'id, transaction_type, amount, credit_type, description, transaction_date';
